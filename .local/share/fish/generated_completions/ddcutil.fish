...
complete -c ddcutil -l wall-timestamp -l wts -d 'Preface trace messages with the current wall time'
complete -c ddcutil -l thread-id -l tid -d 'Preface trace messages with the thread number'
complete -c ddcutil -l syslog -d 'Write trace messages to the system log'
complete -c ddcutil -l excp -d 'Report freed exceptions'
complete -c ddcutil -l use-file-io -d 'Use the write()/read() interface of driver i2c-dev to send and receive I2C pa…'
complete -c ddcutil -l use-ioctl-io -d 'Use the ioctl() interface of driver i2c-dev to send and receive I2C packets'
